...
import { Picker, type PickerOption } from "@/components/molecules/Picker";
          ...
          <>
            ...
            <div className="picker-column day-column">
              <Picker
                options={dayOptions}
                value={value.getDate()}
                onChange={(val) => handleSelectChange("day", Number(val))}
              />
            </div>
          </>
        )}
          ...
          <>
            <div className="picker-column hour-column">
              <Picker
                ...
                onChange={(val) => handleSelectChange("hour", Number(val))}
              />
            </div>
            ...
            <div className="picker-column minute-column">
              <Picker
                ...
                onChange={(val) => handleSelectChange("minute", Number(val))}
              />
            </div>
          </>
        )}
