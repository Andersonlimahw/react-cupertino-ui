...
import glassTokens from "@/lib/constants/tokens/glass";
...
type DialogButtonOptions = Pick<
  ButtonProps,
  "size" | "fullWidth" | "loading" | "icon" | "className"
> & {
  ...
  (
    ...
    <AlertDialogPrimitive.Action ref={ref} asChild {...props}>
      <Button
        ...
        loading={loading}
        icon={icon}
        className={cn("react-cupertino-ui-dialog__button", className)}
      >
        {children}
      </Button>
